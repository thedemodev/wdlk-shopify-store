...
export function scss () {
    ...
    sass.render({
        ...
        if (err) {
            console.log(log.error('Error status: '), err.status);
            console.log(log.error('Error column: '), err.column, log.error('Error Line: '), err.line);
            console.log(log.error('Error found in the file: '), err.file );
